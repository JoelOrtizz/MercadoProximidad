<!--
VISTA: PerfilUsuarioView (PerfilUsuarioView.vue)

Que pantalla es:
- Esta copia refleja el estado actual de frontend/src/views/PerfilUsuarioView.vue.
...
// goBack: gestiona navegacion y contexto entre pantallas.
function goBack() {
  try {
    router.back();
  } catch {
...
// reverseGeocodeCity: centraliza una parte concreta de la logica de esta vista documentada.
...
// loadCityAndRegion: carga datos y actualiza el estado visible de la vista.
...
// clearMarkers: elimina o revierte estado local/remoto de forma controlada.
...
// paintPoints: centraliza una parte concreta de la logica de esta vista documentada.
...
// loadUser: carga datos y actualiza el estado visible de la vista.
...
// loadPoints: carga datos y actualiza el estado visible de la vista.
...
// loadProducts: carga datos y actualiza el estado visible de la vista.
...
// loadValoracionMedia: carga datos y actualiza el estado visible de la vista.
...
// loadAll: carga datos y actualiza el estado visible de la vista.
...
// sendMessage: centraliza una parte concreta de la logica de esta vista documentada.
