<!--
VISTA: ProductoView (ProductoView.vue)

Que pantalla es:
- Esta copia refleja el estado actual de frontend/src/views/ProductoView.vue.
...
// loadProducto: carga datos y actualiza el estado visible de la vista.
...
// loadPuntosEntrega: carga datos y actualiza el estado visible de la vista.
...
// reservar: centraliza una parte concreta de la logica de esta vista documentada.
