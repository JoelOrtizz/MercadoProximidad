  ...
  routes: [
    {
      ...
      meta: { css: "/css/landing.css", hideNav: true },
    },
    {
      path: "/comprar",
      ...
      meta: {
        ...
        header: {
          ...
          subtitle:
            "Productos cercanos, trato directo y confianza en tu ciudad.",
    ...
    { path: "/login", component: LoginView, meta: { css: "/css/login.css" } },
    {
      ...
      meta: { css: "/css/registro.css" },
    },
    {
      path: "/coords",
      component: CoordsView,
      meta: { css: "/css/seleccionarCords.css" },
    },
    {
      path: "/puntos-entrega",
      component: PuntosEntregaView,
      meta: { css: "/css/puntosEntrega.css" },
    },
    {
      path: "/reservas",
    ...
    },
    {
      path: "/mensajes/:id",
      component: MensajesView,
      meta: { css: "/css/mensajes.css" },
    },
    {
      path: "/valoraciones",
      component: ValoracionesView,
      meta: { css: "/css/valoraciones.css" },
    },
    {
      path: "/notificaciones",
      component: NotificacionesView,
      meta: { css: "/css/notificaciones.css" },
    },
    {
      path: "/usuario/:id",
      component: PerfilUsuarioView,
      meta: { css: "/css/perfilUsuario.css" },
    },
    {
      path: "/legal",
      component: LegalView,
      meta: { css: "/css/legal.css", hideNav: true },
    },
    {
      path: "/contacto",
      component: ContactoView,
      meta: { css: "/css/contacto.css", hideNav: true },
    },
    {
      path: "/producto/:id",
      component: ProductoView,
      meta: { css: "/css/producto.css" },
    },
    {
      path: "/favoritos",
      component: favoritosView,
      meta: { css: "/css/comprar.css" },
    },
